...
Config.gains.momentum.KP_linear = 0.1 * [15, 15, 15];         
Config.gains.momentum.KD_linear = 2.5 * sqrt(Config.gains.momentum.KP_linear);
...
Config.gains.torqueControl.KI    = 50;                            
...
% QP boundaries
Config.sat.maxJetsIntVar                     = [200; 200; 200; 200];
Config.sat.maxJetsInt                        = [250; 250; 250; 250];
